...
export default function Projects() {
    return (
        <div className="flex flex-col justify-center items-center gap-12 pt-32 pb-32">
            ...
            <div className="flex flex-wrap justify-center">
                <div className="flex justify-center items-center gap-3 border-2 m-8 w-4/5">
                    <img src={oxenteCafe} alt="" className="w-1/3"/>
